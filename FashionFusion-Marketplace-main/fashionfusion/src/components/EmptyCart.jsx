  ...
  return (
    <div>
        ...
        <div className='absolute top-[30%] left-[10%] w-6/12 items-center flex flex-col'>
            ...
            <h1 className='text-pink-800 text-3xl font-serif mb-2'>Your cart is empty</h1>
            <p className='text-gray-600 text-2xl mb-2'>Add some items to your cart to get started!</p>
